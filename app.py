...
5. 【アクションステップの捏造完全禁止】第3章のアクションステップ（Lv.1〜Lv.3）を出力する際は、LLM自身で独自のアクションやステップ名（例：「観察と準備」など）を絶対に捏造しないこと。必ず、上記で渡された『Lv.Xの正解アクション』の【ステップ名】および【テキスト内容】を一言一句そのまま、あるいはユーザーの環境に不自然にならない範囲での微調整のみで出力すること。
...
{{
  ...
  "chapter3_lv1": "【Lv.1（第1週）】[『Lv.1の正解アクション』のステップ名をそのまま記載]<br><b>やり方と具体例：</b>[『Lv.1の正解アクション』のテキストをベースに、悩みの文脈に完全に一致させて微調整して出力せよ。全く違う行動を捏造することは絶対NG。]",
  "chapter3_lv2": "【Lv.2（第2〜3週）】[『Lv.2の正解アクション』のステップ名をそのまま記載]<br><b>やり方と具体例：</b>[『Lv.2の正解アクション』のテキストをベースに微調整して出力せよ。]",
  "chapter3_lv3": "【Lv.3（第4週）】[『Lv.3の正解アクション』のステップ名をそのまま記載]<br><b>やり方と具体例：</b>[『Lv.3の正解アクション』のテキストをベースに微調整して出力せよ。]"
}}
"""
                            try:
                                response = openai_client.chat.completions.create(
