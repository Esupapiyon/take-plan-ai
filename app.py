...
# 2. 100個の科学的武器庫（各属性20個、計100個の完全版）
    weapons_db = {
        "木": [
            {
                "name": "ツァイガルニク効果",
                "theory": "B.ツァイガルニク（ゲシュタルト心理学）。未完了のタスクは脳のメモリを食う現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】タスクを「完了させる」「実際に作業を進める」提案は認知負荷が高いため絶対NG。「メモ帳アプリを1秒だけ開く」「ノートにペンを置く」など、疲れていても物理的に数秒で終わる【極小アクション（タイニーハビット）】を逃げ道（代替案）として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作（お茶を飲む等）」の直後に、気になっている『未完了の小さなタスク』を1つだけ書き出すミッションを提案せよ。最後は必ず「当然、この魔法（ミッション）を使うかどうかはあなたの自由です」というBYAF法を用いて締めくくること。"
            },
            {
                "name": "If-Thenプランニング",
                "theory": "P.ゴルヴィツァー（ニューヨーク大）。行動のトリガーを事前に決める習慣化手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】複雑な計画や重いタスクのThen（行動）は絶対NG。「スマホを見たら深呼吸を1回する」「画面を1秒閉じる」など、数秒で確実に終わる【極小アクション】を逃げ道として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日だけの小さな「If-Then（もし〇〇したら〇〇する）」のルールを1つ決めてメモするミッションを提案せよ。最後は必ず「当然、この魔法を使うかどうかはあなたの自由です」で締めくくること。"
            },
            {
                "name": "2分間ルール",
                "theory": "D.アレン（GTD理論）。着手にかかる心理的ハードルを極限まで減らす、実務から生まれたタスク管理・生産性向上メソッド。",
                "ai_guardrail": "【翻訳時の絶対ルール】「2分間全力で掃除する」等エネルギーを使う提案は絶対NG。「目の前のゴミを1つ捨てる」「靴を1足揃える」等の、筋肉を少し動かすだけで終わる【極小アクション】を逃げ道として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今すぐ終わる「2分以内の極小タスク」を1つだけ片付けるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "認知的オフローディング",
                "theory": "脳科学。脳内の情報を外部（メモ等）に出力し、ワーキングメモリを解放する手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「全ての悩みを整理する」等の重い認知作業は絶対NG。「メモ帳アプリを1秒開く」「紙の上にペンを置く」等の物理的動作を代替案（逃げ道）として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今頭の中にある「やらなきゃいけないこと」を3つだけ書き出すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "チャンキング",
                "theory": "G.ミラー（認知心理学）。情報を小さな塊（チャンク）に分けることで処理を容易にする。",
                "ai_guardrail": "【翻訳時の絶対ルール】「全体の計画を綿密に立てる」等の重い作業は絶対NG。「最初のステップを1行だけ書く」「スケジュール帳を1秒開く」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、明日の大きな予定を「3つの小さな手順」に分解して書き出すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "メンタル・コントラスティング",
                "theory": "G.エッティンゲン（心理学）。目標達成の障害を事前に想定することで実行力を高める手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「詳細なリスク分析」は絶対NG。「最大の誘惑（スマホ等）を1秒だけ頭に思い浮かべる」等の脳内シミュレーションのみの極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日の最大の目標と、それを邪魔しそうな「最大の誘惑・障害」を1つだけメモするミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "パーキンソンの法則の逆利用",
                "theory": "C.N.パーキンソン。「仕事は与えられた時間をすべて満たすまで膨張する」という法則。",
                "ai_guardrail": "【翻訳時の絶対ルール】「半分の時間で全力で終わらせる」等のプレッシャーをかける指示は絶対NG。「タイマーアプリを開いて時間をセットするだけ」という物理動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日やるべき最小タスクの「締め切り時間」をあえて半分に設定するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "認知再構成法（白黒思考の打破）",
                "theory": "A.ベック（認知行動療法）。極端な認知の歪み（全か無か）を修正し、ストレスを減らす。",
                "ai_guardrail": "【翻訳時の絶対ルール】「ポジティブに考え直す」等の無理な感情の操作は絶対NG。「心の中で『今回は』と1回だけつぶやく」等の数秒の脳内アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「絶対」「すべて」「いつも」という言葉を「今回は」に脳内で置き換えるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "デフォルト・バイアス",
                "theory": "R.セイラー（行動経済学）。人間は初期設定（デフォルト）の行動を選びやすいという特性。",
                "ai_guardrail": "【翻訳時の絶対ルール】「誘惑を完全に断ち切る」「電源を切る」等の意志力に頼る提案は絶対NG。「スマホを裏返して置く」「10センチ遠くに置く」等の極小の物理的摩擦を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、仕事や作業の前にスマホ等を物理的に少し遠ざける環境設定ミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "オヴシアンキナ効果",
                "theory": "M.オヴシアンキナ（心理学）。あえて中断させることで「その作業を再開したくなる強い欲求」が生じる行動面の現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「作業を少し進める」等のタスク着手は絶対NG。「ファイルを開いてすぐ閉じる」「タイトルを1文字だけ書く」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、手をつけたくない作業のファイルを開いてあえて「中途半端にすぐ閉じる」ミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "決断疲れ（Decision Fatigue）",
                "theory": "J.ティアニー等。決断を繰り返すことで脳が疲労し、判断の質が落ちる現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「1日のスケジュールを全て固定する」等は絶対NG。「明日の朝飲む飲み物を決める」「着る服を出す」等の数秒で終わる決断を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、明日の「どうでもいい小さな選択」を1つだけ今日のうちに固定化するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ブレイン・ダンプ",
                "theory": "D.アレン（GTD） / N.コーワン（認知心理学）。ワーキングメモリの容量制限を防ぐための認知的オフローディング。",
                "ai_guardrail": "【翻訳時の絶対ルール】「悩みを完全に整理する」等は絶対NG。「メモ帳の新規作成ボタンを押す」「1単語だけ書く」等の筋肉を動かすだけの極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、頭を占めている「気がかりなこと」を1分間だけ箇条書きで書き出すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "スモールステップの原理",
                "theory": "B.F.スキナー（行動分析学）。目標を極小化し、達成の「強化（報酬）」を即座に与えることで行動を定着させる。",
                "ai_guardrail": "【翻訳時の絶対ルール】「タスクを半分終わらせる」等は絶対NG。「PCの電源を入れるだけ」「ペンを握るだけ」の筋肉を動かすだけのタスクを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日やらなければならない重いタスクの「最初の1分でできること」だけを書き出すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "破局視の修正",
                "theory": "A.ベック（認知行動療法）。「最悪の事態が起きる」という認知の歪み（自動思考）に対して反証を行う。",
                "ai_guardrail": "【翻訳時の絶対ルール】「論理的な解決策を綿密に考える」等は絶対NG。「『最悪死ぬわけじゃない』と心の中で1回つぶやく」等の脳内タイニーハビットを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、不安に思っていることに対し「実際に起こり得る最も現実的なシナリオ」を1行だけ書き出すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ポモドーロ・テクニック",
                "theory": "F.シリロ。着手の心理的ハードルを下げる短時間のタイムボックス手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「絶対に25分集中する」というプレッシャーは絶対NG。「タイマーアプリを開いて25分にセットするだけ（開始はしなくてよい）」等の物理動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、タイマーを25分にセットしスマホを裏返して没頭するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ホフスタッターの法則",
                "theory": "D.ホフスタッター（認知科学）。「作業は常に予想以上の時間を要する」という法則。",
                "ai_guardrail": "【翻訳時の絶対ルール】「正確なスケジュールを引き直す」等は絶対NG。「カレンダーアプリを1秒開く」「予定時間に『×1.5』と書き込むだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今からやるタスクの完了予定時間を見積もり、その数字に強制的に「1.5倍」を掛けて再設定するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "損失回避性（プロスペクト理論）",
                "theory": "Kahneman & Tversky（行動経済学）。人は「利益を得る」より「損失を避ける」ことに強く動機づけられる現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「損失を綿密に計算する」等は絶対NG。「『今日やらないと〇〇の時間が無駄になる』と脳内で1回つぶやく」等の脳内アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、サボりたくなった時に「今日やらないと今まで積み上げた時間が無駄になる」とメモに書くミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "認知的フリクションの追加",
                "theory": "行動デザイン。悪い習慣を減らすため、物理的・認知的な「手間（摩擦）」を意図的に1ステップ増やす。",
                "ai_guardrail": "【翻訳時の絶対ルール】「アプリを全て消去する」等のハードルが高い行動は絶対NG。「スマホを裏返す」「引き出しに1秒だけ入れる」等の極小の物理動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、集中したい時間の前に誘惑への物理的な「手間（摩擦）」を1ステップ増やすミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "間隔効果（分散学習）",
                "theory": "H.エビングハウス（記憶心理学）。一度に集中して学習するより、間隔を空けて復習する方が記憶の定着率が高い。",
                "ai_guardrail": "【翻訳時の絶対ルール】「テキストを1ページ復習する」等の認知負荷は絶対NG。「本を机の上に出すだけ」「メモを1秒だけ視界に入れる」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、新しいことを学ぶのではなく、過去に読んだ本の「ハイライト（重要な1文）」だけを30秒見直すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "パレートの法則（80:20の法則）",
                "theory": "V.パレート / J.ジュラン。全体の8割の成果は、2割の要素（タスク）によって生み出されるという経験則。",
                "ai_guardrail": "【翻訳時の絶対ルール】「タスクの優先順位を完璧に分析する」等は絶対NG。「TODOリストを開く」「赤ペンを手に持つだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日のTODOリストのうち「最も成果に直結する重要な2割」だけを赤いペンで丸で囲むミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            }
        ],
      "火": [
            {
                "name": "エクスプレッシブ・ライティング",
                "theory": "J.ペネベーカー（テキサス大）。感情を書き出すことでストレスホルモンを低下させる。",
                "ai_guardrail": "【翻訳時の絶対ルール】「長文で感情を整理する」等の認知負荷が高い提案は絶対NG。「メモ帳アプリを1秒だけ開く」「いらない紙とペンを用意するだけ」等、疲れていても物理的に数秒で終わる【極小アクション（タイニーハビット）】を逃げ道（代替案）として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作（お茶を飲む等）」の直後に、ネガティブな感情を誰にも見せないメモに1分間だけ書き殴るミッションを提案せよ。最後は必ず「当然、この魔法（ミッション）を使うかどうかはあなたの自由です」というBYAF法を用いて締めくくること。"
            },
            {
                "name": "表情フィードバック仮説",
                "theory": "F.ストラック等（心理学）。表情筋の動きが脳の感情認識を後追いさせる現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「常に笑顔でいるようにする」等の持続的な精神論は絶対NG。「トイレで1秒だけ口角を上げる」「頬の筋肉を1回触る」等の筋肉を動かすだけの極小の物理動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、誰もいない場所で2秒間だけ無理やりにでも口角を上げて笑顔を作るミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "パワーポーズ（身体化された認知）",
                "theory": "A.カディ等（心理学）。姿勢などの身体的動作が、感情や自己評価に影響を与える現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「自信を持つよう意識する」等の内面へのアプローチは絶対NG。「背筋を1センチだけ伸ばす」「両手を腰に1秒だけ当てる」等の極小物理動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、立ち上がり、胸を張って両手を腰に当てるポーズを10秒間とるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "アサーティブネス",
                "theory": "臨床心理学。自他を尊重した自己表現手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「実際に相手に意見を言う」等の高負荷な対人タスクは絶対NG。「メモに『私は』と1文字だけ書く」「心の中で1回つぶやく」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「本当はこう言いたかった」という本音を自分を責めずに1行だけ書き出すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ラベリング（感情の言語化）",
                "theory": "M.リーバーマン（UCLA）。感情に名前をつけるだけで扁桃体の興奮が鎮まる脳科学現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「感情の原因を深く分析する」等の重い認知作業は絶対NG。「『あ』と1文字だけメモする」「深呼吸を1回する」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今の自分の感情にピタッとくる名前を1つだけつけるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ネーム・イット・トゥ・テイム・イット",
                "theory": "D.シーゲル（脳科学）。感情（右脳）に名前（左脳）をつけることで、扁桃体の暴走を鎮める。",
                "ai_guardrail": "【翻訳時の絶対ルール】「感情を相手に伝える」等の対人タスクは絶対NG。「心の中で『モヤモヤ』と1回つぶやくだけ」等の脳内タイニーハビットを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、モヤモヤした時に「私は今〇〇について圧倒されている」と自分に実況中継するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "意図的表情表出",
                "theory": "P.エクマン等（心理学）。特定の表情筋（眼輪筋と大頬骨筋）を意図的に動かして生理的変化を人工的に引き起こす。",
                "ai_guardrail": "【翻訳時の絶対ルール】「人前で明るく振る舞う」等の感情労働は絶対NG。「鏡を1秒見るだけ」「目尻を1回指で触るだけ」等の極小物理動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、鏡の前で目尻にシワが寄るほどの「全力の笑顔の形」を3秒間だけキープするミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "セルフ・アファメーション理論",
                "theory": "C.スティール（社会心理学）。自分の「中核となる価値観」を確認することで、脅威への耐性を高める。",
                "ai_guardrail": "【翻訳時の絶対ルール】「人生の目標を壮大に語る」等は絶対NG。「『誠実』など好きな単語を1つ頭に浮かべるだけ」「メモを1秒開く」等の数秒で終わるアクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、自分が大切にしている価値観を1つ選び、なぜ大切かを1行で書くミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "思考の廃棄（Thought Discarding）",
                "theory": "川合伸幸等（認知科学）。怒りを書き出した紙そのものを物理的に捨てることで怒りを鎮静化させる手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「怒りの原因を根本から解決する」等は絶対NG。「いらない紙を1枚用意するだけ」「紙を1回だけ破る」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、いらない紙の切れ端にイライラを書き込み、細かく破いて捨てるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "感謝の表明（プロソーシャル行動）",
                "theory": "R.エモンズ（ポジティブ心理学）。他者への感謝の表現が、自身の幸福度と自己肯定感を直接的に高める。",
                "ai_guardrail": "【翻訳時の絶対ルール】「長文の感謝の手紙を書く」等は絶対NG。「心の中で『ありがとう』と1回つぶやく」「会釈を1回する」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、誰かに普段より1トーン明るい声で「ありがとう」と伝えるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ポリヴェーガル理論（迷走神経刺激）",
                "theory": "S.ポージェス（生理心理学）。腹側迷走神経複合体を刺激することで、社会的な安心感を活性化させる。",
                "ai_guardrail": "【翻訳時の絶対ルール】「本格的な瞑想を10分する」等の時間は絶対NG。「息を1秒だけ長く吐く」「口をすぼめるだけ」等の極小の身体動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、息を吐くときに「フー」とハミングのような音を出しながら10秒間だけ長く息を吐くミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "非暴力コミュニケーション（NVC）",
                "theory": "M.ローゼンバーグ（臨床心理学）。評価や判断を交えず事実とニーズを伝える手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「実際に相手と話し合う」等の高負荷タスクは絶対NG。「メモを1秒開く」「『私は』という主語を1回思い浮かべる」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、誰かへの不満を「私は〇〇を大切にしたいから、今〇〇と感じている」という構文でメモに書くミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "感謝の恩恵（Gratitude Letter）",
                "theory": "M.セリグマン（ポジティブ心理学）。他者への感謝を具体的に言語化することで、自分自身の幸福度が向上する。",
                "ai_guardrail": "【翻訳時の絶対ルール】「実際に手紙を送る」等のハードルの高い行動は絶対NG。「送る相手の顔を1秒思い浮かべる」「宛名だけ書く」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、実際に送らなくてもいいので、身近な誰かへの2行の感謝の手紙をメモに書くミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "自己開示の返報性",
                "theory": "S.ジュラード（対人心理学）。自分の弱さや本音を少しだけ見せることで、相手との心理的距離が急激に縮まる現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「重い相談を打ち明ける」等は絶対NG。「『疲れた』と心の中でつぶやく」「LINEの入力画面を1秒開く」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、信頼できる人に「実は最近〇〇で少し悩んでいて」と小さな弱音を1つ言葉にして伝えるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "アクティブ・コンストラクティブ・レスポンディング",
                "theory": "S.ゲーブル（社会心理学）。他者の「良い出来事」に対して、積極的かつ建設的に反応することが関係性を最も強化する。",
                "ai_guardrail": "【翻訳時の絶対ルール】「常にハイテンションでいる」等の感情労働は絶対NG。「心の中で『いいね』と1回つぶやく」「少しだけ声のトーンを上げる」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日誰かの嬉しい話を聞いたら、いつもより1段階高いテンションで反応するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ピグマリオン効果",
                "theory": "Rosenthal & Jacobson（教育心理学）。他者からの「心からの期待」を受けると、その期待に沿うようにパフォーマンスが向上する。",
                "ai_guardrail": "【翻訳時の絶対ルール】「相手を熱血指導する」等の重い関わりは絶対NG。「心の中で『大丈夫』と1回念じるだけ」「自分自身に1回うなずく」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、部下や家族、または自分自身に対して「あなたなら絶対に乗り越えられる」と一言だけ明確に伝えるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "自己決定理論（SDT）",
                "theory": "Deci & Ryan（心理学）。内発的動機づけには「自律性・有能性・関係性」の3つが必要不可欠であるという理論。",
                "ai_guardrail": "【翻訳時の絶対ルール】「仕事の進め方を根底から変える」等の重いタスクは絶対NG。「使うペンを1秒で選ぶ」「作業場所を10センチずらす」等の物理的で極小の自己決定を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、どうしてもやりたくない仕事に対して「いつやるか」「どのペンを使うか」など自分が100%決定権を持つ部分を1つ探すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "カクテルパーティー効果",
                "theory": "C.チェリー（認知心理学）。音声の洪水の中でも、自分に必要な情報だけは無意識に選択的注意が向く現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「会議の内容を完璧にメモする」等は絶対NG。「キーワードを1つ頭に浮かべるだけ」「メモに1単語書くだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、会議や会話の前に「今日は『〇〇』というキーワードが出たら必ず反応する」と1つだけ決めておくミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ミラーニューロンの活性化",
                "theory": "G.リゾラッティ等（脳神経科学）。他者の行動を見るだけで、自分が同じ行動をしているかのように脳の神経細胞が発火する。",
                "ai_guardrail": "【翻訳時の絶対ルール】「長時間の動画で学習する」等は絶対NG。「YouTubeアプリを1秒開く」「サムネイルを1つ見るだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、自分がやらなければならない作業を「楽しそうにやっている人の動画」を1分間だけ見るミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ペーシング",
                "theory": "M.エリクソン（臨床心理学）。相手の非言語的特徴（呼吸、声のトーン）を合わせることで、無意識の安心感を築く。",
                "ai_guardrail": "【翻訳時の絶対ルール】「相手の行動を完璧にコピーする」等の高負荷タスクは絶対NG。「相手の呼吸を1回だけ見る」「1秒だけ黙る」等の極小の観察アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、次に会話する相手の「声の大きさ」または「話すスピード」に、最初の1分間だけ意図的に合わせるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            }
        ],
      "土": [
            {
                "name": "スリー・グッド・シングス",
                "theory": "M.セリグマン（ポジティブ心理学）。幸福度を永続的に高める感謝のワーク。",
                "ai_guardrail": "【翻訳時の絶対ルール】「長文で日記を書く」等の高い認知負荷は絶対NG。「メモ帳アプリを1秒開く」「心の中で『ご飯が美味しかった』と1回つぶやくだけ」等の数秒で終わる極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日あった「ちょっと良かったこと」をどんな些細なことでもいいので3つ書き出すミッションを提案せよ。最後は必ず「当然、この魔法（ミッション）を使うかどうかはあなたの自由です」というBYAF法を用いて締めくくること。"
            },
            {
                "name": "マインドフル・イーティング",
                "theory": "ジョン・カバット・ジン（マインドフルネス）。今この瞬間に意識を向ける認知療法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「食事中ずっと意識を集中する」等の持続的な努力は絶対NG。「最初の一口の1秒だけ目を閉じる」「箸を一度置くだけ」等の極小物理動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、次の食事や飲み物の「最初の一口」だけ目を閉じて味覚に全集中するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "サボアリング（味わい）",
                "theory": "F.ブライアント（ポジティブ心理学）。ポジティブな経験や対象に意識的に注意を向け、その喜びを意図的に増幅させる手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「長時間をかけて鑑賞する」等は絶対NG。「お気に入りのペンを1秒触るだけ」「写真を1回見るだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、身の回りの一番お気に入りのアイテムを10秒間見つめ、魅力を再確認するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "習慣のスタッキング",
                "theory": "S.J.スコット / B.J.フォッグ。既存の強固な習慣をトリガーにして、新しい微小な行動を紐付ける行動デザイン手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「30分の勉強を追加する」等の重い習慣は絶対NG。「本を机の上に置くだけ」「靴を履く前に深呼吸を1回するだけ」等の数秒の物理動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後にやる「新しい小さな行動」を1つ決めて実行するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "プライミング効果",
                "theory": "J.バーグ等（認知心理学）。先行して見聞きした刺激が、その後の無意識の思考や行動の方向性を決定づける現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「部屋の模様替えをする」等の重い作業は絶対NG。「スマホの待ち受けを1枚変えるだけ」「机に好きな写真を1枚置くだけ」等の極小の環境設定を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、一番最初に目に入る場所に「気分を高める好きな言葉や写真」を置くミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "5-4-3-2-1 グラウンディング",
                "theory": "トラウマケア・不安緩和療法。五感に意識を向け、パニックや不安から「今ここ」に意識を戻す手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「五感を全て完璧に確認する」等のハードルは絶対NG。「目の前にある『青いもの』を1つ探すだけ」「机の冷たさを1秒触るだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、目に見えるものを5つ、触れるものを4つ…と五感をカウントダウンするミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "単純接触効果",
                "theory": "R.ザイアンス（心理学）。繰り返し接するものに好意や安心感を抱く現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「毎日何十分も見る」等は絶対NG。「スマホのアルバムを1秒開くだけ」「画像をウィジェットに置くだけ」等の無意識レベルの極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、リラックスできる風景や好きなものの写真をスマホで開き、10秒間ただじっと眺めるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "マイクロ・ドーパミン・デトックス",
                "theory": "A.レンブケ（精神医学）。過剰なドーパミン刺激を遮断し、脳の報酬系をリセットする。",
                "ai_guardrail": "【翻訳時の絶対ルール】「1日中スマホを見ない」等の非現実的な提案は絶対NG。「スマホを1分間だけ裏返す」「画面設定を白黒にする設定画面を開くだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、1時間だけスマホの画面設定を「白黒（モノクローム）モード」に変更するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "プログレスの法則",
                "theory": "T.アマビール（組織心理学）。日々の「小さな進捗」の認識が、モチベーションを最も高める。",
                "ai_guardrail": "【翻訳時の絶対ルール】「詳細な日報を書く」等は絶対NG。「TODOリストに1つだけチェックを入れる」「完了と1単語メモするだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日終わらせたどんな些細なことでも1つ書き出して丸で囲むミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "マインドフル・ウォーキング",
                "theory": "マインドフルネス（歩行瞑想）。自動操縦モードの脳を休ませ、身体感覚に意識を向ける。",
                "ai_guardrail": "【翻訳時の絶対ルール】「30分間歩き続ける」等の運動提案は絶対NG。「立ち上がった時の最初の1歩だけ意識する」「足の裏の感覚を1秒だけ感じる」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、移動中の「最初の10歩」だけ足の裏が地面に触れる感覚に全集中するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ノスタルジアの心理的効用",
                "theory": "C.ルートレッジ（心理学）。過去の温かい記憶を呼び起こすことで、孤独感が減少し、人生の意味への感覚が高まる。",
                "ai_guardrail": "【翻訳時の絶対ルール】「アルバムを整理する」等の時間は絶対NG。「写真アプリを1秒開くだけ」「楽しかった記憶のキーワードを1つ浮かべるだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、スマホのアルバムを遡り「楽しかった旅行や友人の写真」を1枚選び10秒間眺めるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "タクティカル・ブリージング",
                "theory": "生理学。吸う・止める・吐く・止めるの秒数を均等にし、心拍数を強制的に下げる。",
                "ai_guardrail": "【翻訳時の絶対ルール】「何セットも完璧に行う」等のプレッシャーは絶対NG。「ただ1回だけ深くため息をつく」「息を4秒吸うだけ」等の筋肉を少し動かすだけの極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「4秒吸う、4秒止める、4秒吐く、4秒止める」四角形の呼吸を3セット行うミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "プラセボ睡眠",
                "theory": "A.クラム（スタンフォード大）。「自分は十分な休息を取った」と思い込むだけで、実際の認知機能の低下が防げる現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「無理に思い込ませて働き続ける」等のブラックな提案は絶対NG。「『とりあえず寝た』と1回心でつぶやくだけ」「鏡を1秒見るだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、睡眠不足でも「今日の自分の脳は十分休めた」と鏡に向かって1度だけ声に出すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ナッジ",
                "theory": "R.セイラー（行動経済学）。物理的な環境を変えることで望ましい行動を誘導する。",
                "ai_guardrail": "【翻訳時の絶対ルール】「部屋の配置を完璧にする」等は絶対NG。「水を10センチ手前に置くだけ」「本を開いて机に置くだけ」等の数秒で終わる物理的配置を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、やりたい良い習慣のアイテムを「自分の利き手に一番近い位置」に配置するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ボディスキャン瞑想",
                "theory": "J.カバットジン（マインドフルネス）。意識を身体の各部位に順番に向けることで、脳の過活動を鎮める。",
                "ai_guardrail": "【翻訳時の絶対ルール】「全身を30分かけてスキャンする」等の高負荷タスクは絶対NG。「右足のつま先だけ1秒意識する」「肩を1回だけ落とす」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、目を閉じ、つま先から頭まで順番に「今の重さや温度」を10秒間観察するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "サンクコストの誤謬の認識",
                "theory": "Arkes & Blumer（行動経済学）。回収不可能なコストに引きずられ、不合理な継続をしてしまう心理。",
                "ai_guardrail": "【翻訳時の絶対ルール】「今すぐ全てを捨てる決断をする」等の心理的抵抗が強い提案は絶対NG。「『もしゼロからならやるか？』と1回心で自問するだけ」の脳内アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、惰性で続けていることに対し「もし今日ゼロからなら始めるか？」と自問するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ピーク・エンドの法則",
                "theory": "D.カーネマン（行動経済学）。経験の記憶は「絶頂時」と「終了時」の感情だけで決定される。",
                "ai_guardrail": "【翻訳時の絶対ルール】「最後を完璧に仕上げる」等は絶対NG。「一番簡単な作業を1つだけ最後に残す」「PCを閉じる時だけ深呼吸する」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日の仕事の「一番最後」に最も簡単で気持ちよく終わるタスクを意図的に持ってくる計画を立てるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "環境エンコーディング",
                "theory": "Godden & Baddeley（認知心理学）。情報を記憶した時と同じ環境にいると想起が容易になる。",
                "ai_guardrail": "【翻訳時の絶対ルール】「完璧な暗記術を実践する」等は絶対NG。「付箋を1枚鏡に貼るだけ」「メモアプリを1秒開いておく」等の極小の物理的アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、明日の朝思い出したことを付箋に書き「確実に最初に見る場所」に貼るミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "習慣の逆転法",
                "theory": "Azrin & Nunn（行動療法）。無意識の悪い癖が出そうになった瞬間、それと同時にできない別の身体動作を行う。",
                "ai_guardrail": "【翻訳時の絶対ルール】「悪い癖を完全にやめる」等の意志の力に頼る提案は絶対NG。「両手を1秒だけ強く握る」「ペンを1回置く」等の簡単な筋肉の動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、イライラして悪い癖が出そうになったら代わりに「両手を10秒間強く握りしめる」ミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "マインドセット効果",
                "theory": "A.クラム（スタンフォード大）。主観的な思い込みがプラセボとして生理的反応を変える現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「常に全てをポジティブに思い込む」等は絶対NG。「水を飲む前に『これは効く』と1回だけ心でつぶやく」等の数秒の脳内タイニーハビットを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、ただの水を飲む時に「これは自律神経をリセットする水だ」と強く念じてから飲むミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            }
        ],
      "金": [
            {
                "name": "5秒ルール",
                "theory": "M.ロビンズ。脳が「やらない言い訳」を考える前にカウントダウンで思考を強制終了させ、行動を開始する手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「そのまま重い作業を始める」等の高いハードルは絶対NG。「心の中で『5、4、3、2、1』とカウントダウンするだけ」「1ミリだけ指を動かすだけ」等の極小アクションを逃げ道（代替案）として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作（お茶を飲む等）」の直後に、心の中で「5、4、3、2、1」とカウントダウンしゼロになった瞬間に立ち上がる（または最小の動作をする）ミッションを提案せよ。最後は必ず「当然、この魔法（ミッション）を使うかどうかはあなたの自由です」というBYAF法を用いて締めくくること。"
            },
            {
                "name": "行動活性化療法",
                "theory": "認知行動療法（CBT）。気分ではなく「行動」を先に行うことでドーパミンを出す。",
                "ai_guardrail": "【翻訳時の絶対ルール】「1時間運動する」等の負担の大きい行動は絶対NG。「その場で1回だけ背伸びする」「次の1歩だけ歩幅を広げる」等の物理的な極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、気分が乗らなくてもあえて「歩くスピードを少しだけ上げる」など行動を先にするミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "プレマックの原理",
                "theory": "D.プレマック（行動心理学）。「やりたいこと」を報酬にして「やるべきこと」を促す。",
                "ai_guardrail": "【翻訳時の絶対ルール】「1時間の勉強を条件にする」等の重いタスクは絶対NG。「『PCを開いたらコーヒーを1口飲む』という数秒のルールを1つ頭に浮かべるだけ」等の脳内アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「これを5分やったらあの動画を見る」という小さなご褒美ルールを1つ設定してメモするミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "コントロールの所在（内的統制）",
                "theory": "J.ロッター（心理学）。自分でコントロールできる事に集中し無力感を防ぐ。",
                "ai_guardrail": "【翻訳時の絶対ルール】「全ての問題の解決策を練る」等は絶対NG。「『これは私の管轄外だ』と心の中で1回つぶやくだけ」等の数秒の脳内タイニーハビットを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今抱えている問題のうち「自分ではどうにもならないこと」を1つ諦め、手放す宣言をするミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "選択回避の法則",
                "theory": "S.アイエンガー（コロンビア大）。選択肢が多すぎると決断できなくなる現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「1週間の予定を全て決める」等は絶対NG。「明日の靴下だけ出しておく」「次飲むお茶の種類を1秒で決める」等の極小の決断を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、明日着る服や次食べるメニューなど「どうでもいい決断」を今1つだけ固定化するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "テンプテーション・バンドリング",
                "theory": "K.ミルクマン（行動経済学）。「やりたいこと（誘惑）」と「やるべきこと」をセットにする習慣化。",
                "ai_guardrail": "【翻訳時の絶対ルール】「過酷な作業とセットにする」等は絶対NG。「『好きな曲を聴きながら靴を履く』というルールを1秒思い浮かべるだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「好きな音楽を聴くのは〇〇の作業中だけ」というマイルールを今日1つ作るミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "タイムボックス手法",
                "theory": "ソフトウェア開発。時間を厳格に区切り、パーキンソンの法則を防ぐ。",
                "ai_guardrail": "【翻訳時の絶対ルール】「何時間も連続してスケジュールを組む」等は絶対NG。「タイマーアプリを1秒開くだけ」「『次は5分だけやる』と心で決めるだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、タイマーを「15分間」にセットし、時間が来たら作業の途中でも絶対に手を止める箱を作るミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "プレモルテム（事前の検死）",
                "theory": "G.クライン（認知心理学）。計画が「大失敗した」と仮定して、その原因を事前に潰すリスク管理手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「何十個もリスクを書き出して対策を練る」等の高負荷タスクは絶対NG。「最大の失敗原因を1単語だけメモに書く」「1秒だけ最悪の事態をイメージする」等を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日の計画が全て台無しになるとしたら「何が原因か」を1つだけ想定し、対策を1行メモするミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "最適多様性",
                "theory": "脳科学。脳は「新しい刺激」を検知するとドーパミンを出し、集中力を回復させる。",
                "ai_guardrail": "【翻訳時の絶対ルール】「旅行に行く」等の大きな変化の提案は絶対NG。「利き手と逆の手でマグカップを1回持つだけ」「マウスを1センチずらすだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、利き手と逆の手でドアを開けるなど、日常に1つだけ違和感を作るミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "バッチ処理",
                "theory": "生産性工学。タスクの切り替え（コンテキスト・スイッチ）による脳の疲労を防ぐ。",
                "ai_guardrail": "【翻訳時の絶対ルール】「1日中バッチ処理で働く」等は絶対NG。「同じアプリを2回連続で開く」「『今はこれだけ』と1秒つぶやくだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今から短時間だけ「メールの返信だけ」など同種の作業に絞って一気に片付けるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "目標勾配仮説",
                "theory": "C.ハル（行動心理学）。ゴールが近づくにつれて、モチベーションは加速度的に高まる現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「100個のリストを作る」等は絶対NG。「TODOリストに1つだけチェックボックスを書く」「『終わった』と1文字書くだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日やるべきタスクをあえて「細かいチェックリスト」にし、終わったものから勢いよく線を引いて消すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "10分間ルール",
                "theory": "認知行動療法。不安な課題に対し、「たった10分だけでいいから」と条件をつけて着手させ作業興奮を誘発する。",
                "ai_guardrail": "【翻訳時の絶対ルール】「そのまま1時間やり続ける」事を強要するのは絶対NG。「『10分でやめる』と1回声に出すだけ」「ファイルを開いてすぐ閉じるだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、ずっと後回しにしている作業に「10分経ったら絶対にやめていい」という免罪符を与え着手するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "コーピング・プランニング",
                "theory": "行動科学。「障害が起きた時の対処法」を事前にIf-Thenで決めておくリスク対応手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「複雑なマニュアルを作る」等は絶対NG。「『スマホを見たら深呼吸』と1行だけ書く」「誘惑を1つ思い浮かべるだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「今日もし〇〇（サボる誘惑）が起きたら、××をして回避する」というルールを1つだけメモに書くミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ソマティック・マーカー仮説",
                "theory": "A.ダマシオ（脳神経科学）。身体的反応（直感）が、論理的思考よりも早く正しい意思決定を導くという理論。",
                "ai_guardrail": "【翻訳時の絶対ルール】「直感だけで重大な決断をさせる」等は絶対NG。「コインを1回投げるだけ」「『AかBか』と1秒だけ目を閉じて直感を感じるだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、迷っている選択肢でコインを投げ、舞っている瞬間の「自分の直感（どっちが出てほしいか）」を探るミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "作業興奮の誘発",
                "theory": "E.クレペリン（心理学）。着手のハードルを下げてドーパミンを出す手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「そのまま作業を完了させる」等の高いハードルは絶対NG。「ペンを1回握るだけ」「PCの電源を入れるだけ」の純粋な筋肉運動のみを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、迷って動けない時、考えるのをやめて「資料のファイルを新規作成するだけ」等の物理的な第一歩を踏むミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "限界効用逓減の法則",
                "theory": "H.ゴッセン等（経済学）。作業量が増えるにつれ、1単位あたりの追加的な価値は次第に減少していく。",
                "ai_guardrail": "【翻訳時の絶対ルール】「すべての作業を適当に終わらせる」等は絶対NG。「『もう十分だ』と1回声に出すだけ」「保存ボタンを1回押すだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「完璧」を目指して長引いている作業に対し「ここから先は労力に見合わない」と判断し今すぐ終わらせるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "サティスファイシング",
                "theory": "H.サイモン（行動経済学）。最大化を求めず、事前に決めた「十分な基準」を満たした最初の選択肢で決断を終える。",
                "ai_guardrail": "【翻訳時の絶対ルール】「仕事の重大な決断を適当にする」等は絶対NG。「『何でもいい』と1回つぶやくだけ」「一番上のメニューを1秒で指差すだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日のランチ等を選ぶ際、「〇〇であればOK」という最低基準を決め、それを満たす最初に出たものに即決するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "コミットメント・デバイス",
                "theory": "行動経済学。将来の自分の行動を縛るために、今のうちに制限を自ら課す仕組み。",
                "ai_guardrail": "【翻訳時の絶対ルール】「絶対に達成できない過酷な宣言をする」等は絶対NG。「チャットの入力欄を開くだけ」「『〇時までにやる』と自分のメモに1行書くだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、誰かに「15時までに〇〇を送ります」と先に宣言し、自分自身に逃げられないプレッシャーをかけるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ストレスの再評価介入",
                "theory": "A.クラム（スタンフォード大）。ストレス反応を肯定的に捉え直すことでパフォーマンスが向上する。",
                "ai_guardrail": "【翻訳時の絶対ルール】「無理にテンションを上げて興奮状態にする」等は絶対NG。「『心臓が動いている』と1回心でつぶやくだけ」「胸に1回手を当てるだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、緊張で心臓がドキドキした時「体が酸素を送り込んで、私を助けようとしている」と声に出して実況するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ラピッド・プロトタイピング",
                "theory": "デザイン思考 / ソフトウェア工学。即座に低解像度の試作品を作ることで心理的ハードルを下げるアプローチ。",
                "ai_guardrail": "【翻訳時の絶対ルール】「そのまま完璧な資料を作る」等は絶対NG。「『あ』と1文字だけメモに書く」「白紙のノートを1秒眺めるだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、何から手をつければいいか分からないタスクに対し、メモ帳に「世界一雑でひどい構成案（箇条書き3つ）」を1分で作るミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            }
        ],
      "水": [
            {
                "name": "脱フュージョン",
                "theory": "S.ヘイズ（ACT）。思考と自分を切り離す手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「ポジティブな思考に無理やり書き換える」等は絶対NG。「『〜と思った』と心の中で1回つぶやくだけ」「メモ帳に『〜と思った』と1行書くだけ」等の数秒で終わる極小アクションを逃げ道（代替案）として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作（お茶を飲む等）」の直後に、「私はダメだ」という思考に対し「私はダメだ【と思った】」と語尾に名札をつけるミッションを提案せよ。最後は必ず「当然、この魔法（ミッション）を使うかどうかはあなたの自由です」というBYAF法を用いて締めくくること。"
            },
            {
                "name": "セルフ・コンパッション",
                "theory": "K.ネフ（テキサス大）。自分への慈悲が自己肯定感とレジリエンスを高める。",
                "ai_guardrail": "【翻訳時の絶対ルール】「問題から完全に逃げて自分を甘やかす」等は絶対NG。「『大丈夫』と心の中で1回つぶやくだけ」「肩を1回だけ撫でる」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、親友が落ち込んでいる時にかけるような「優しい慰めの言葉」を自分自身にかけるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "自己距離化（フライ・オン・ザ・ウォール）",
                "theory": "E.クロス（ミシガン大）。第三者視点を持つことで感情の暴走を抑えるメタ認知。",
                "ai_guardrail": "【翻訳時の絶対ルール】「感情を完全に殺して冷酷になる」等は絶対NG。「天井を1秒見上げるだけ」「目を閉じてハエを1匹想像するだけ」等の極小の物理・脳内アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今の自分を天井に止まっている「一匹のハエ」の視点から客観的に見下ろして観察するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ラディカル・アクセプタンス",
                "theory": "弁証法的行動療法（DBT）。変えられない現実を、良い悪いを判定せずにそのまま受け入れる。",
                "ai_guardrail": "【翻訳時の絶対ルール】「人生に絶望し無気力になる」等の学習性無力感を促す表現は絶対NG。「『今はこういう状態だ』と1回声に出すだけ」「深呼吸を1回するだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「今日は疲れている」という自分の現状を一切否定せずに受け入れるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "リフレーミング",
                "theory": "認知心理学。物事の枠組み（フレーム）を変えて別の視点から意味づけを行う。",
                "ai_guardrail": "【翻訳時の絶対ルール】「無理やり素晴らしい経験だったと思い込む」等は絶対NG。「『テストだった』と1文字メモするだけ」「『まあいいか』と1回つぶやくだけ」等の数秒のタイニーハビットを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日の失敗や嫌だった出来事を「これは〇〇を学ぶためのテストだった」と言い換えるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ソクラテス式問答法",
                "theory": "A.ベック等。自問自答により自分の思い込みの矛盾に気づく認知的手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「証拠を何時間も探して自己分析する」等の高負荷タスクは絶対NG。「『本当か？』と心で1回問うだけ」「『？』をメモに1つ書くだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、自分が「絶対に無理だ」と思っていることに対し「その証拠は100%確実か？」と1回問いかけるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "マインドフル・リスニング",
                "theory": "マインドフルネス。判断を交えず、ただ環境音や言葉に集中する手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「10分間本格的な瞑想をする」等の高いハードルは絶対NG。「1秒だけ目を閉じる」「一番近くの音を1つだけ認識する」等の数秒の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、次の1分間聞こえてくる環境音だけをジャッジせずにただ聴き続けるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "オーバービュー・エフェクト",
                "theory": "F.ホワイト。宇宙飛行士が地球を見て価値観が変わる現象を応用した、認知のスケールチェンジ。",
                "ai_guardrail": "【翻訳時の絶対ルール】「自分の存在価値は無意味だ」と虚無主義に陥らせる表現は絶対NG。「空を1秒だけ見上げる」「地図アプリを1タップで開くだけ」等の物理的動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、空を見上げるか地図アプリで地球儀を表示し「この宇宙の中で自分の悩みはどれくらいのサイズか」を考えるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "拡張形成理論",
                "theory": "B.フレドリクソン。ポジティブな感情が、思考と行動の選択肢（視野）を広げる現象。",
                "ai_guardrail": "【翻訳時の絶対ルール】「動画を何時間も見て現実逃避する」等の浪費行動は絶対NG。「癒やされる画像を1秒だけ見る」「スマホの待ち受けを1回見るだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、動物の癒やされる動画や壮大な自然の動画を「30秒間」だけ意図的に見るミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ジョハリの窓",
                "theory": "J.ルフト / H.インガム（対人心理学）。盲点の窓にフォーカスし自己認識を深める手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「他人に長文のフィードバックを求める」等の対人ハードルは絶対NG。「過去に褒められた単語を1つだけ思い浮かべる」「1単語だけメモする」等の脳内・極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「人からよく指摘される自分のポジティブなクセや特徴」を1つ書き出してみるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "イレイシズム（三人称の自己対話）",
                "theory": "E.クロス（ミシガン大）。心の中の独り言を「自分の名前（三人称）」に変えるだけで客観性が増す。",
                "ai_guardrail": "【翻訳時の絶対ルール】「声に出して長文の独り言を言う」等の不自然な行動は絶対NG。「心の中で自分の名前を1回呼ぶだけ」「『〇〇ならどうする？』と1秒自問するだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、悩んでいることに対し心の中で「（自分の名前）は今どうするべきか？」と他人にアドバイスするように問いかけるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "グロース・マインドセット",
                "theory": "C.ドゥエック（スタンフォード大）。否定的な自己評価に「Yet（まだ）」をつける手法。",
                "ai_guardrail": "【翻訳時の絶対ルール】「今すぐできるようになるため猛特訓する」等は絶対NG。「『今はまだ』と心で1回つぶやくだけ」「メモに『まだ』と2文字書くだけ」等の数秒の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、「自分にはできない」と思った瞬間、その言葉の最後に「…今のところは（まだ）」と付け足すミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "葉っぱの上の思考",
                "theory": "S.ヘイズ（ACT）。思考を自分と同一化させず、ただ流れていくものとして観察する。",
                "ai_guardrail": "【翻訳時の絶対ルール】「不安を完全に消し去るまで瞑想する」等は絶対NG。「目を1秒閉じるだけ」「『流れた』と心で1回唱えるだけ」等の脳内タイニーハビットを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、頭に浮かんだ不安を「川を流れる葉っぱ」の上に乗せ、ただ目の前を通り過ぎていくのを10秒間イメージするミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "知的謙遜",
                "theory": "認知科学。自分の知識の限界を認めることが学習能力を高める。",
                "ai_guardrail": "【翻訳時の絶対ルール】「自分は無能だと激しく落ち込む」等の自己卑下は絶対NG。「『知らない』と1回心でつぶやくだけ」「検索窓を1秒開くだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日出会った分からない言葉や事象に対して「私はこれについてまだ知らない」と声に出して認めるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "メタ認知の意識化",
                "theory": "J.フラベル（発達心理学）。「自分の認知活動そのものを認知する」ことで感情的リアクティビティを下げる。",
                "ai_guardrail": "【翻訳時の絶対ルール】「なぜなぜ分析を延々と繰り返す」等の泥沼化は絶対NG。「『なぜ？』と心の中で1回疑問符を浮かべるだけ」「肩の力を1回抜くだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今感じている強い感情に対して「なぜ私は今この感情を抱いているのか？」ともう一人の自分が質問するミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "ダニング＝クルーガー効果のメタ認知",
                "theory": "Kruger & Dunning（認知心理学）。能力が低い人ほど自己評価を過大に見積もる認知バイアスを防ぐ。",
                "ai_guardrail": "【翻訳時の絶対ルール】「自分の決断を全て疑って行動をやめる」等は絶対NG。「『何か見落としは？』と1秒自問するだけ」「メモを1回見直すだけ」等の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、今日自分が自信満々に判断したことに対して「私がまだ見落としている前提条件は何か？」と疑うミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "確証バイアスの意図的打破",
                "theory": "P.ウェイソン（認知心理学）。人は自分の仮説を支持する情報ばかりを集める傾向を逆手に取る。",
                "ai_guardrail": "【翻訳時の絶対ルール】「反対意見に完全に服従する」等は絶対NG。「検索窓に『〇〇 デメリット』と入力するだけ」「反対派の意見を1行だけ読む」等の数秒の物理動作を代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、自分が「絶対に正しい」と思っている意見に対し、あえて「真逆の意見（反対派の論理）」を検索して読むミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "マインドワンダリングの許容",
                "theory": "M.コーバリス等（脳科学）。意識的な思考を手放し「心がさまよう」状態が創造性に不可欠である（DMNの活性化）。",
                "ai_guardrail": "【翻訳時の絶対ルール】「スマホを見ながらダラダラ休憩する」等は絶対NG。「窓の外を1秒見るだけ」「天井のシミを1つ見つけるだけ」等の極小の視線移動アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、次の休憩の2分間、スマホを一切見ずに窓の外の風景等をただぼーっと眺め脳をさまよわせるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
                "name": "セルフ・コンパッション・ブレイク",
                "theory": "K.ネフ（ポジティブ心理学）。苦痛を感じた際、それを共通の人間体験として認識し、自分に親切にする介入。",
                "ai_guardrail": "【翻訳時の絶対ルール】「長時間瞑想して完璧に心を癒やす」等は絶対NG。「胸に手を1秒当てるだけ」「『辛い』と1回心で認めるだけ」等の数秒の極小アクションを代替案として含めること。",
                "rule": "【生成ルール】ユーザーの悩みに合わせ、「毎日必ず行う日常の動作」の直後に、失敗した時、胸に手を当てて「これは苦しい瞬間だ」「誰もが同じように苦しむ」「私は私に優しくしよう」と順番に唱えるミッションを提案せよ。最後は必ずBYAF法で締めくくること。"
            },
            {
