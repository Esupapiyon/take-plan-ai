...
{{
  ...
  "chapter3_lv3": "【Lv.3（第4週）】[『Lv.3の正解アクション』のステップ名をそのまま記載]<br><b>やり方：</b>[『Lv.3の正解アクション』をベースに微調整して出力]<br><b>具体例：</b>[指定された環境下で実際に口に出すリアルなセリフや行動を「1. 」「2. 」と番号を振って2つ出力]<br><b>注意点：</b>[実践時の具体的な注意点を出力]"
}}
"""
                            try:
                                response = openai_client.chat.completions.create(
